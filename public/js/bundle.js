...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.113497, 34.111745],
    // zoom: 10,
    // interactive: false
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, "<br>").concat(location.description, "</p>")).addTo(map); // Extends the map bounds, to include the current location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signing off...');
              window.setTimeout(function () {
                location.assign('/');
              }, 2000);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Failed to sign out, try again.');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/update-password' : 'http://127.0.0.1:3000/api/v1/users/update-user-profile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51ITFLfJLQZ73Z8fXIKYlRg4DEQDUPHqrTlNtru7P6msZRDArC04WadDIWm1MwYYObQwcNXl2zq3xd78Z1HkphfSJ00uswAqCc0'); // Gets checkout session from the API.
...
var signForm = document.querySelector('.form--sign-in');
var signOutButton = document.querySelector('.nav__el--sign-out');
...
if (userPassForm) {
  userPassForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
...
;
if (bookTourButton) bookTourButton.addEventListener('click',
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(e) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.target.textContent = 'Processing...'; // e.target - The event that got clicked.
