      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            console.log(session); // Creates checkout form, charges the credit card.
...
var bookTourButton = document.querySelector('book-tour');
...
if (bookTourButton) bookTourButton.addEventListener('click', function (e) {
  e.target.contentText = 'Processing...'; // e.target - The event that got clicked.
